...
list_onetime_links = [line.strip() for line in open("D:\\BSAK\\onetimeLinkGenerator\\generated_links.txt", 'r')]
...
with smtplib.SMTP_SSL("smtps.mail.uni-kiel.de", 465, context=context) as server:
    ...
    for i in range(0, len(users)):
        ...
        message["Subject"] = "(BSAK Election 2020) Instructions, Link for token and voting form."
